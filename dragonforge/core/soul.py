...
class Soul:
    ...
    habits: Dict[str, float] = field(default_factory=lambda: {
        ...
        "любит ночные полёты под звёздами": 0.38,
        "шепчет имена созвездий": 0.28,
        "ставит седло под луну": 0.32,
    })
    ...
    def evolve(self, interaction: Dict):
        ...
        habit_triggers = {
            ...
            "боится громкого грома": ["гром", "гроза", "молния"],
            ...
            "любит ночные полёты под звёздами": ["ночь", "ночн", "звезд", "звёзд", "луна", "лунн"],
            "шепчет имена созвездий": ["созвезд", "орион", "полярис", "млечный путь", "звёздн"],
            "ставит седло под луну": ["луна", "лунн", "под лун", "седло"],
        }
